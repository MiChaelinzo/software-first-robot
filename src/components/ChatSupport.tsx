...
const DEFAULT_SUGGESTIONS: ChatSuggestion[] = [
  { id: '2', text: 'Show me the analytics dashboard', category: 
  { id: '2', text: 'Show me the analytics dashboard', category: 'action' },
  { id: '3', text: 'How does collision avoidance work?', category: 'question' },

 

export function ChatSupport() { = useState<ChatMessage[]>([])
  const [isOpen, setIsOpen] = useState(false)e('')
